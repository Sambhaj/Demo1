...
<div class="container-fluid"  style="background-color:#015070">
          ...
          <form method="POST" action="" enctype="multipart/form-data"> 
		         <center> <table style="border-radius: 20px;width:50%;background-color:#99b3ff;" >
                  ...
                  <a href="view_exams.php"><input type="button" id="btn" name="View" style="color:#ffffff;background-color:#015070" value="View" > </a>		
		          </td>
		          </tr>
		 		</table> </center>
    ...
    <thead>
        ...
        <tr  >
            <?php $result = mysql_query("SELECT * FROM tb_docs_exams") or die(mysql_error()); 
            $row_count = 1;
...
?>
    ...
    <a href="delete1.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this  ?')" name="delete1"><img src="images/delete_icon.png"></a>
