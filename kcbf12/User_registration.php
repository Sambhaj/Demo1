...
$tnature=$_POST['nature_of_business'];
/* $specific_details=$_POST['specific_details']; */

$deds=$_POST['specific_details'];
...
// for image upload
		                $file_name=$_FILES["uploadpassport_img"]["name"];
                                $temp_name=$_FILES["uploadpassport_img"]["tmp_name"];
                                $imgtype=$_FILES["uploadpassport_img"]["type"];
				$ext= GetImageExtension($imgtype);
				$imagename=$_FILES["uploadpassport_img"]["name"];
				  echo"$imagename";
				$target_path = "doc/doc1/".$imagename;
			
				move_uploaded_file($temp_name, $target_path); 
// for image upload1
                                $file_name1=$_FILES["uploadbusiness_cards"]["name"];
                                $temp_name1=$_FILES["uploadbusiness_cards"]["tmp_name"];
                                $imgtype1=$_FILES["uploadbusiness_cards"]["type"];
				$ext1= GetImageExtension($imgtype1);
				$imagename1=$_FILES["uploadbusiness_cards"]["name"];
				  echo"$imagename1";
				$target_path1 = "doc/doc2/".$imagename1;
 ...
 
{
	...
	mysql_query("INSERT INTO  tbmember_registration(serial_no,registration,reg_date,name,address,country,state,city,pincode,landline_no,mobile_no,birth_date,ekda,email,trade_type,trade_name,nature_of_business,specific_details,trade_address,trade_location,trade_pincode,trade_designation,trade_mobile_1,trade_mobile_2,trade_email,trade_website,trade_description,fill_date,upload_passport_img,upload_business_card) VALUES('$new_id','$reg','$tdate','$name','$address','$country','$state','$city','$pincode','$landline','$Mobile','$bddate','$ekda','$email','$trade','$tname','$tnature','$deds_joined','$taddress','$tlocation','$trade_pincode','$tdesignation','$mobile_1','$mobile_2','$temail_2','$twebsite','$tdescription','$current_date','$target_path','$target_path1')");
	$sucss="Registration Done Successfully!...";
...
<script>
// nature_of_business
var nature_arr = new Array("Accounting/Finance", "Advertising/Marketing/Digital", "Agriculture/Diary", "Appret/Garments", "Architecture/interior Design","Automobile/Parts& Spares", "Banking/Financial Services", "Book/Stationery", "Chemical/Dyes/Solvants","Computer/Accessories & Hardware","Construction/Cements/Metals","Doctor","Education/Training","Electrical/Suppies","Elecrtonic/Home Appliances","Engineering/Ferrous/Non Ferrous/Metals","Fashion Accessories/Gears","FMCC/Food & Beverages","Furniture/Furnishing","Germs & jewellery/Bullion","Home Décor/Gifts/ Arts/Artifacts","House keeping Services","Industrial Plants/Machinery/Supplies","Insurance","IT/BPO/KPO","Legal","Mechanical/Parts & Spares","Media/Dotcom/Entertainment","Medical/Healthcare/Hosptial","NGO/Social Services","Oil and Gas/Power/Infrastructure/Projects","Others","Packaging/Prianting/Publishing","Papers/Plastic/Rubber","Pharma/Biotech/Clinical Research","PR/Event Management","Professional Services","Real Estate/Property","Security Systems & services","Telecom/ISP","Textile/Yarn & Fabrics","Transpotation & Logistics","Travels/Hotel/Airlines/Restaurants","Wellness/Fitness/Sports")
// Specific_details
var s_aa = new Array();
s_aa[0]  = "";
s_aa[1]  = "Arth capital advisor pvt Ltd|Dinesh invesments|Dinesh M  Chhajed And Company|Finmen Advisors pvt Ltd|IBN Technologies Ltd";
s_aa[2]  = "chhajer Marketing|crayons Advertising Pvt Ltd|IBN Technologies Ltd|N Racca Advertising Marketing|Regal Graphics";
s_aa[3]  = "Aadrik Distributors Pvt Ltd|Bhanpurawala Agencies Pvt Ltd|Fashion Suiting Pvt Ltd|Jain Spices and agro products india Pvt Ltd|Namo Export";
s_aa[4]  = "BEST CLOTHING|Bhairav corporation|Bodyline Lingerie(I) Pvt Ltd|Fashion Suiting Pvt Ltd|Garment House";
s_aa[5]  = "Aanya Arts|Boolean Design Studio|Jainsons Locks Co Pvt Ltd|Knobs Kart LLP|Mantra Gold Coatings";
s_aa[6]  = "Marudhar Builders|Vardhaman Cables Conductors|A V Motors|A J Auto Pvt Ltd|Aadrik Distributors Pvt Ltd";
s_aa[7]  = "9 Financial Advisory Services|A R Solanki Stock Pvt Ltd|A C Group|Abcd Technology|Abhinandan Motors Pvt Ltd";
s_aa[8]  = "Chhajer Marketing|Devraj Infotech Private Limited|PRINT MEDIA OFFSET|Viva Global";
s_aa[9]  = "Karneet Enterprises India Pvt Ltd|Vinayak Pharmaceuticals|A. J. Auto Pvt. Ltd|Aadinath Distributors|Aarti Industries Limited";
s_aa[10] = "A K Paper Product Pvt Ltd|Abcd Technology|Abhinandan Motors Pvt Ltd|Adani Group Of Companies|Ajay Time/ K. T. Watches /Payal Watch Company";
s_aa[11] = "Marudhar Builders|32Acre|7am mantras|9 Financial Advisory Services|A Class Marbles Pvt. Ltd";
s_aa[12] = "Bangalore orthopaedic & Diagnostic";
s_aa[13] = "7am mantras|Gyan Ganga Institute of Technology and Sciences|Gyan Ganga International School|ICA Edu Skills Pvt Ltd|ICA Eduskills P Ltd";
s_aa[14] = "Nahata Comfort Systems Pvt Ltd|Namolectric Controls|PYRAMID SYSTEM|Runwal Building Solution|Shree Bhagyashri Electricals";
s_aa[15] = "J K Electronics & Appliances Pvt Ltd|Jainsons Locks Co Pvt. Ltd|Jk Electronics & Appliances Pvt Ltd|Jk Elekctronics & Appliances Pvt Ltd|Jk Elekctronics & Appliances Pvt Ltd";
s_aa[16] = "Ranka Steel|7am mantras|A. C. Strips Pvt Ltd|A. Daga Group|A. S. Vasan & Sons";
s_aa[17] = "Bodyline Lingerie (I) Pvt. Ltd.|Fashion Suiting Pvt Ltd|Jain Amar Clothing|Ketan Buttons Pvt Ltd|M/S. Gulmarg Beauty";
s_aa[18] = "Abhinav singhvi|Apsara Tea- Surajmal Tea Pvt Ltd|Arth Capital Advisors Pvt Ltd.|Balai Nutriex|Bhikhchand Kachrulalji Raka";
s_aa[19] = "Bantia Furnitures|Hariom Decor (P) Ltd|Knobs Kart LLP|Mantra Gold Coatings|Mirius Interni LLP";
s_aa[20] = "4 Ever Fashion|A G Gems (P) Ltd|Aabushan|Aabushan|Aadeshwar Academy";
s_aa[21] = "Boolean Design Studio|Devraj Infotech Private Limited|Hariom Decor (P) Ltd|innovative commercial inc|Knobs Kart LLP";
s_aa[22] = "S. R. Papers";
s_aa[23] = "Ajmera Enterprise|Arvind Bearing Company|Hitech Sweet Water Tech Pvt Ltd|ITL Industries Ltd.|Namolectric Controls";
s_aa[24] = "Arth Capital Advisors Pvt Ltd.|Jain Property|Myanmol Financial Services LLP|Raj Dhariwall & Co|Smart Policy";
s_aa[25] = "IBN Technologies Ltd.|Mystic Solutions|N. R. Doshi & Partners|Pns Corporate Service Pvt Ltd|PYRAMID SYSTEM";
s_aa[26] = "Arth Capital Advisors Pvt Ltd.|Dinesh M Chhajed And Company|Rsm Astute Consultech Pvt Ltd.|Unity management Consultants Pvt Ltd";
s_aa[27] = "Arihant Bearing Services Pvt Ltd|ITL Industries Ltd.|Unity management Consultants Pvt Ltd";
s_aa[28] = "Arissan Group|Take A Right Technologies Pvt. Ltd.";
s_aa[29] = "Bangalore orthopaedic & Diagnostic|Biosensors International|D5 Lifesciences LLP|Kothari Health Care (P) Ltd.|Mahaveer Medicare / IDRS Labs Pvt Ltd";
s_aa[30] = "BANK OF BARODA|N. R. Doshi & Partners|Siddharth International";
s_aa[31] = "Mahati Industries Pvt Ltd|Parmar Traders|PYRAMID SYSTEM|Rayvision Tech P Ltd|Sara Infrastructure";
s_aa[32] = "3 icons|32Acre|39 Solutions|A B Impex|A C Jain Builders & Developers";
s_aa[33] = "Devraj Infotech Private Limited|Flexifoil Packaging Pvt Ltd|MAXHEAL Pharmaceuticals (I) Ltd.|Medi Sales India Pvt. Ltd.|MILLION PAPIER PRIVATE LIMITED";
s_aa[34] = "Venkateshwara Industries Packaging|A R Solanki Stock Pvt Ltd|Aadeshwar Print N Pack|Abhinandan Petro Pack Pvt Ltd|Ajmera Enterprise";
s_aa[35] = "Bionova|Biosensors International|D5 Lifesciences LLP|Mahaveer Medicare / IDRS Labs Pvt Ltd|MAXHEAL Pharmaceuticals (I) Ltd.";
s_aa[36] = "Crayons Advertising Pvt Ltd";
s_aa[37] = "Service|360 Legal|A K Kanunga & Co|A.Kasliwal & Company|Aadrik Distributors Pvt. Ltd.";
s_aa[38] = "Abhinav singhvi|Arissan Group|Fashion Suiting Pvt Ltd|Jain Property|Knobs Kart LLP";
s_aa[39] = "Jainsons Locks Co Pvt. Ltd|Pentagon Automation Concepts|Rajesh Bhutoria|Unity management Consultants Pvt Ltd";
s_aa[40] = "Easy Cell City|Fuel Technologies International Private Limited|Giriraj Infocom India Pvt Ltd|Rajesh Bhutoria";
s_aa[41] = "Chhajer Synthetics Pvt Ltd|'Rooptara' Saree Centre|4 Ever Fashion|A K Spintex Ltd|A-One Packaging";
s_aa[42] = "Deluxe Logistics Pvt Ltd|Krystal Steel Manufacturing Pvt Ltd|M D Movers";
s_aa[43] = "4Wheels Travels|A.C.N. Tradecon Pvt Ltd|Adinath Dairy Company|Akhil Bharatiya Bhagyoday Parishad|Amba Shipping Agencies";
s_aa[44] = "Bodyline Lingerie (I) Pvt. Ltd.|Fashion Suiting Pvt Ltd|Nikhil Runwal";




function populateStates1(countryElementId, stateElementId) {
    ...
    var state_arr = s_aa[selectedCountryIndex].split("|");
...
function populateCountries1(countryElementId, stateElementId) {
    // given the id of the <select> tag as function argument, it inserts <option> tags
    var countryElement = document.getElementById(countryElementId);
    countryElement.length = 0;
    ...
    for (var i = 0; i < nature_arr.length; i++) {
        countryElement.options[countryElement.length] = new Option(nature_arr[i], nature_arr[i]);
    }
    ...
    if (stateElementId) {
        countryElement.onchange = function () {
            populateStates1(countryElementId, stateElementId);
        };
    }
}</script>
<script type="text/javascript">
function CheckColors(val){
 var element=document.getElementById('ekda');
...
<a  href=" http://khadayatabusinessnetwork.com/wp/"><img src="images/KBN logo.png" style="padding-left:2px;padding-top:6px;"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a  href="http://khadayatabusinessnetwork.com/wp/" style="font-family:Roboto Condensed;color:white;font-size:16px">  HOME</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            
 <a  href="http://khadayatabusinessnetwork.com/wp/about-us/" style="font-family:Roboto Condensed;color:white;font-size:16px">ABOUT US</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <div class="dropdown">
  ...
  <div class="dropdown-content" >
    ...
    <a href="http://khadayatabusinessnetwork.com/wp/event-business-seminar/" style="font-family:Roboto Condensed;color:white;font-size:14px">BUSINESS SEMINARS</a>
	 <a href="http://khadayatabusinessnetwork.com/wp/event-picnic/" style="font-family:Roboto Condensed;color:white;font-size:14px">PICNIC</a>
  </div>
</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="container-fluid"  >
   <div class="container" >
				...
				<table >
					  <tr >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;       
                        <span style="font-size: 30px;color: white;font-family: Roboto Condensed;text-align:center">REGISTRATION FORM</span>
    ...
    <div class="row"  >
     <div class="col-md-10">
      ...
      <center>
		<table width="60%" cellspacing="10px" cellpadding="2px" style= "border: 1px solid #a1a1a1; background-color:#f7dca3;border: border-collapse: collapse;
    border-radius: 30px;
    border-style: hidden; 
    box-shadow: 0 0 0 3px white; border-radius: 40px;margin:50px;">
		...
		<tr><td style="padding:5px;font-size:18px;" colspan="4"><span style="color:#DF1018;"><?php echo $msg;?></span><span style="color:green;"><?php echo $sucss;?></span></td></tr>
		<tr></tr>
		<tr style="height:60px"><td colspan="4" style="font-weight:bold;font-size:28px;text-align:center; background-color:#ffae00;font-family: Roboto Condensed;border-radius:30px;">Personal Information</td></tr>
		<tr>

		    <td style="font-size:16px;visibility: hidden;width:23%"><span style="color:#DF1018;"><?php echo $req;?></span> Serial No</td>
	        <td style="width:40%"><input type="text" style="background-color:white;height:22px;width:60%;visibility: hidden;font-family: Roboto Condensed"  name="serial_no" id="serial_no"  value="<?php echo @$new_id;?>"readonly="readonly"></td>
            <td></td>
			<td></td>
		</tr>
		 <tr>
		    <td style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Name<span style="color:red">    *</span></td>
            <td ><input type="text"  style="background-color:white;height:22px;width:60%;font-family: Roboto Condensed" required="required"   name="name" id="name"    value="<?php echo isset($_POST['name']) ? $_POST['name'] : ''; ?>"></td>
	        <td  style="font-size:16px;font-family: Roboto Condensed;text-align:left"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Address<span style="color:red">    *</span</td>
            <td rowspan="2"><textarea  style="background-color:white;width:100%;height:57px;font-family: Roboto Condensed;text-align:left" required="required"  name="address" id="address" value="<?php echo isset($_POST['address']) ? $_POST['address'] : ''; ?>"></textarea ></td>
        </tr>
		<tr>
		    <td   style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>City<span style="color:red">    *</span></td>
	        <td ><input type="text" style="background-color:white;width:60%;height:22px;font-family: Roboto Condensed"  name="city" required="required" id="city" value="<?php echo isset($_POST['city']) ? $_POST['city'] : ''; ?>"></td></tr>
		 <tr>
             <td style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Country</td>
             <td style="width:40%">
			 <select id="country" name="country" style="background-color:white;height:28px;width:60%"></select>
		     <script language="javascript">
                    populateCountries("country", "state");
                    
             </script> 
			 </td>
			 <td style="font-size:16px;font-family: Roboto Condensed"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>State</td>
             <td >
				<select name="state" id="state" style="background-color:white;width:102%;height:28px;"></select>
		     </td>
			 
		</tr>

		 <tr>
     		 <td   style="font-size:16px;font-family: Roboto Condensed;text-align:center">  <span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Email<span style="color:red">    *</span</td>
             <td ><input type="text"   style="background-color:white;width:60%;height:22px;font-family: Roboto Condensed"  name="email" required="required" onblur="emailvalidate();" id="email"   value="<?php echo isset($_POST['email']) ? $_POST['email'] : ''; ?>"></td>
             <td   style="font-size:16px;font-family: Roboto Condensed"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Pincode</td>
             <td ><input type="text" style="background-color:white;width:102%;height:22px;font-family: Roboto Condensed"  name="pincode"   id="pincode"    value="<?php echo isset($_POST['pincode']) ? $_POST['pincode'] : ''; ?>"></td>
          
		</tr>
		<tr>
             <td style="font-size:16px;font-family: Roboto Condensed;text-align:center">   <span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Landline No</td>
             <td ><input type="text"   placeholder="" style="background-color:white;height:22px;width:60%;font-family: Roboto Condensed" name="landline_no" id="phno"    value="<?php echo isset($_POST['landline_no']) ? $_POST['landline_no'] : ''; ?>"></td>
             <td style="font-size:16px;font-family: Roboto Condensed"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Mobile No<span style="color:red">    *</td>
             <td ><input type="text"    style="background-color:white;width:102%;height:22px;font-family: Roboto Condensed" onblur="mobval();" required="required" name="mobile_no"  id="mobno"  value="<?php echo isset($_POST['mobile_no']) ? $_POST['mobile_no'] : ''; ?>"></td >
	 
        </tr>
		<tr>  
              <td  style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Birth Date<span style="color:red">    *</span</td>
	          <td ><input type="text" style="background-color:white;width:60%;height:22px;font-family: Roboto Condensed" required="required"  class="tcal" placeholder="DD/MM/YYYY" name="birth_date" id="datepicker" value="<?php echo isset($_POST['birth_date']) ? $_POST['birth_date'] : ''; ?>"></td>
		      <td  style="font-size:16px;font-family: Roboto Condensed"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Ekda</td>
              <td>
							 <select style="background-color:white;width:102%;height:28px;" name="ekda" onchange='CheckColors(this.value);'> 
	                      <option value="--Select--">--Select--</option>
				            <option value="Modasa">Modasa</option>
							 <option value="Nadiad">Nadiad</option>
							 <option value="Umreth">Umreth</option>
							 <option value="Ekvish Gaam">Ekvish Gaam</option>
							 <option value="Ter Gaam">Ter Gaam</option>
							 <option value="Rajpipla">Rajpipla</option>
							 <option value="Saurashtra">Saurashtra</option>
							 <option value="Atasan">Atasan</option>
							 <option value="Nandarbar">Nandarbar</option>
							 <option value="Janod">Janod</option>
							 <option value="Vejalpur">Vejalpur</option>
							 <option value="Haldervas">Haldervas</option>
							 <option value="Mandi Revar">Mandi Revar</option>
                          <option value="others">others</option>
  </select>
  <br>
<input type="text" name="ekda" id="ekda" style='display:none;width:102%;'/>
		     </td>
		</tr>
		...
		<tr style="height:60px"><td colspan="4" style="font-weight:bold;font-size:28px;text-align:center;font-family: Roboto Condensed;background-color:#ffae00;border-radius:30px;">Trade Information</td></tr>
		<tr></tr>
		<tr></tr>
		<tr></tr>
		<tr> 
		    <td  style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed;text-align:center"><?php echo $req;?></span>Name<span style="color:red">    *</span</td>
            <td><input type="text" style="background-color:white;width:60%;height:22px;font-family: Roboto Condensed"  name="trade_name" required="required" id="trade_name"  value="<?php echo isset($_POST['trade_name']) ? $_POST['trade_name'] : ''; ?>"></td>
            <td  style="font-size:16px;font-family: Roboto Condensed;"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Address<span style="color:red">    *</span</td>
            <td><textarea  style="background-color:white;width:100%;font-family: Roboto Condensed" required="required"  name="trade_address" id="trade_address" value="<?php echo isset($_POST['trade_address']) ? $_POST['trade_address'] : ''; ?>"></textarea ></td>
    
		</tr>
		<tr><td  style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Location</td>
            <td ><input type="text" style="background-color:white;width:60%;height:22px;font-family: Roboto Condensed"   name="trade_location" id="trade_location" value="<?php echo isset($_POST['trade_location']) ? $_POST['trade_location'] : ''; ?>"></td>
		
		<td   style="font-size:16px;font-family: Roboto Condensed"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Pincode</td>
             <td ><input type="text" style="background-color:white;width:102%;height:22px;font-family: Roboto Condensed"  name="trade_pincode" id="trade_pincode"     value="<?php echo isset($_POST['trade_pincode']) ? $_POST['trade_pincode'] : ''; ?>"></td>
				</tr>
		 <tr>
		    <td style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;"><?php echo $req;?></span>Type</td>
            <td style="font-size:16px;font-family: Roboto Condensed" colspan="3">
			     <input type="radio" name="trade_type" value="business(self Employee)" >Business (Self-Employed)<br/>
	             <input type="radio" name="trade_type"    value="service" >Service
            </td>
        </tr>
		 
		<tr>
            <td  style="font-size:16px;width:24%;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Business Category</td>
            <td style="font-family: Roboto Condensed"><select id="nature_of_business" name="nature_of_business" style="background-color:white;width:60%;height:28px;"></select>
		     <script language="javascript">
                    populateCountries1("nature_of_business", "specific_details");
                    
             </script> 
			</td>
			 <td  style="font-size:16px;font-family: Roboto Condensed;"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Specific Details</td>
            <td >
					<input type="text"  style="background-color:white;width:102%;font-family: Roboto Condensed" required="required"  name="specific_details" id="specific_details" value="<?php echo isset($_POST['specific_details']) ? $_POST['specific_details'] : ''; ?>"></textarea >
		 ...
		 <tr>
	         ...
	         <td   style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Email<span style="color:red">    *</span</td>
	         <td ><input type="text" style="background-color:white;width:60%;height:22px;font-family: Roboto Condensed"  name="trade_email" required="required" onblur="emailvalidate1()" id="email1" value="<?php echo isset($_POST['trade_email']) ? $_POST['trade_email'] : ''; ?>"></td>
	         <td  style="font-size:16px;font-family: Roboto Condensed"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Designation</td>
	         <td ><input type="text" style="background-color:white;width:102%;height:22px;font-family: Roboto Condensed"  name="trade_designation" id="trade_designation" value="<?php echo isset($_POST['trade_designation']) ? $_POST['trade_designation'] : ''; ?>"></td>
		</tr>
		 <tr>
	         <td  style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Mobile 1<span style="color:red">    *</span</td>
	         <td ><input type="text" style="background-color:white;width:60%;height:22px;font-family: Roboto Condensed" onblur="mobval2();" required="required" name="trade_mobile_1" id="mobno2" value="<?php echo isset($_POST['trade_mobile_1']) ? $_POST['trade_mobile_1'] : ''; ?>"></td>
	         <td   style="font-size:16px;font-family: Roboto Condensed"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Mobile 2</td>
	         <td ><input type="text" style="background-color:white;width:102%;height:22px;font-family: Roboto Condensed" onblur="mobval2();" name="trade_mobile_2" id="mobno2" value="<?php echo isset($_POST['trade_mobile_2']) ? $_POST['trade_mobile_2'] : ''; ?>"></td>
	    </tr>
		<tr>
	         <td   style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Website</td>
	         <td ><input type="text" style="background-color:white;width:60%;height:22px;font-family: Roboto Condensed"  name="trade_website" id="trade_website" value="<?php echo isset($_POST['trade_website']) ? $_POST['trade_website'] : ''; ?>"></td>
		     <td   style="font-size:16px;font-family: Roboto Condensed"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Description</td>
		     <td ><input type="text" style="background-color:white;width:102%;height:22px;font-family: Roboto Condensed"  name="trade_description" id="trade_description" value="<?php echo isset($_POST['trade_description']) ? $_POST['trade_description'] : ''; ?>"></td>

	      
	
	   </tr>
	   <tr>
		          <td style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Upload Passport Image</td>
		          <td>
		          <input name="uploadpassport_img" type="file">
		          </td></tr>
				  <tr>
		          <td style="font-size:16px;font-family: Roboto Condensed;text-align:center"><span style="color:#DF1018;font-family: Roboto Condensed"><?php echo $req;?></span>Upload Business Card</td>
		          <td>
		          <input name="uploadbusiness_cards" type="file">
		          </td></tr>
	    	    <tr> 
		<td style="font-size:16px;font-family: Roboto Condensed;text-align:center"><form id="registrationForm">
<div class="form-group" class="form-horizontal">
        <label class="col-xs-3 control-label">Terms and Conditions</label>
        <div class="col-xs-5" style="width:10%">
           <td style="background-color:white;"> <div style="border: 1px solid #e5e5e5; height: 200px; overflow: auto; padding: 10px;">
                <p style="font-size:12px;font-family: Roboto Condensed;text-align:justify">I hereby express my desire to become a member of Khadayata Community Business Forum(KCBF). I state that I am residing in the geographical location of Maharashtra state and that the information provided is true to best of my knowledge. I understand that my admission is solely at the discretion of the Management of the Forum. I agree to pay / have paid the membership Fees {Rs.2500/- + taxes (as applicable)} of the Forum. Membership Fees are non-refundable and non-transferable. Applicants who have submitted the forms earlier along with the membership fees need not fill out the entire form or attach the photograph again.</p>
                
        </div>
    </div>

  <tr> <td colspan="2"  style="font-size:16px;font-family: Roboto Condensed;text-align:right"> <div class="form-group">
        <div class="col-xs-6 col-xs-offset-3">
            <div class="checkbox">
                <label>
                    <p><input type="checkbox" name="agree" value="agree"/>I Agree with the terms and conditions</p>
                </label>
            </div>
        </div></td></tr>
    </div>
		...
		<input style="font-family: Roboto Condensed;color:white;background-color:#ffae00;height:50px;width:120px;font-weight:bold;font-size:15px;border: border-collapse: collapse;
    border-radius: 30px;"type="submit" class="utt10" id="btn" value="Submit" name="submit">
