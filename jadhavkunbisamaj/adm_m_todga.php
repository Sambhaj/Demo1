...
<form action="adm_m_todga.php" method="post" enctype="multipart/form-data">
<ul>
...
if(isset($_POST['Submit']))                        //check post back event
{
	...
	mysql_set_charset('utf8');
  		$qry="update tbmahinacha_todga set  suvichar='$suvichar'";	
...
<tr><td>Mahinacha Todga &nbsp;</td><td><textarea name="txtsuvichar" cols="40" rows="5"><?php echo $suvichar;?></textarea></td></tr>
