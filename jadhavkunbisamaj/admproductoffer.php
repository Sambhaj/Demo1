...
$from = " Enter mail id here";          //enter mail id here
$headers = "From:" . $from;

if($message != "")
{
    $qr="select email as email from tbregistration where promotional_offer=1";
...
echo "<script> alert('Promostional offer sent to user')</script>";

}
else
{
	echo "<script> alert('Please enter product detail')</script>"; 
}
}
?>
...
<br />
<table>
<tr><td height="116">Product Offer Detail</td>
  <td><textarea name="message" rows="10" cols="30" ><?php echo $message;?> </textarea></td>
</tr>
