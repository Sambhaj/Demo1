...
//updimgs("img");                          //here called function to upload imgae to server folder
	...
	$qry="insert into tblatest_news values('$newsid','$headline','$news','$image','$pdate','$submitby')";	
...
echo  '<META http-equiv="refresh" content="0;URL=frmlatest_news.php">';           
}
else
{
...
<br />
<form action="frmlatest_news.php" method="post">
<table>
</tr>
...
<tr><td>Create Date</td><td> <input type="text" name="pdate" class="tcal" value="" size=16/></td></tr>
