...
//updimgs("img");                          //here called function to upload imgae to server folder
	...
	{
	$qry="insert into tbbirth_death values('$newsid','$headline','$news','$image','$pdate','$submitby','$birthdate')";	
...
<form action="frmbirth_death.php" method="post">
<table>
</tr>
...
<tr><td>Birth Date</td><td> <input type="radio" value="Yes" name="Yes" <?php if (isset($birthdate) && $birthdate=="1") echo "checked";?>  />Yes<input type="radio" value="No" name="Yes" <?php if (isset($birthdate) && $birthdate=="0") echo "checked";?> />No   </td></tr>
