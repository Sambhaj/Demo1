...
<ul>
	...
	<li><input type="submit" style="background:transparent; border:none; font-size:14px; font-weight:bold; color:#FFFFFF;" name="logout"  value="Log Out" /> &nbsp;&nbsp;&nbsp;Welcome : <?php echo "$nm1"; ?></li>	
</ul></form>
</div>
...
$qr="Select * from tbregistration where member_id=$mid";
...
$qry="Update tbregistration set first_name='$fname',father_name='$fathername',surname='$surname',created_by='$createdby',current_status='$current_status',address='$address',mobile_no='$mobno',landline_no='$landlineno',taluka='$taluka',district='$district',country='$country',age='$age',gender='$gender',height='$height',birth_date='$birthdate',native='$native',complex='$complex',mname='$mname',uncle_name='$unclename',religion='$religion',caste='$caste',sub_caste='$subcast',gotra='$gotra',qualification='$qualification',degree='$degree',current_job_profile='$jobprofile',company='$company',work_experience='$experience',service_type='$sv_type',service_location='$service_location',annual_income='$annualincome',other_remark='$remark',expectation='$expection',expection_job='$expectionjob',email='$email',send_sms='$sendsms',promotional_offer='$promotionoffer',activate='$activate',verified='$verified' where member_id=$memberid";
	...
	{
$qry="Update tbregistration set first_name='$fname',father_name='$fathername',surname='$surname',created_by='$createdby',current_status='$current_status',address='$address',mobile_no='$mobno',landline_no='$landlineno',taluka='$taluka',district='$district',country='$country',age='$age',gender='$gender',height='$height',birth_date='$birthdate',native='$native',complex='$complex',mname='$mname',uncle_name='$unclename',religion='$religion',caste='$caste',sub_caste='$subcast',gotra='$gotra',qualification='$qualification',degree='$degree',current_job_profile='$jobprofile',company='$company',work_experience='$experience',service_type='$sv_type',service_location='$service_location',annual_income='$annualincome',other_remark='$remark',expectation='$expection',expection_job='$expectionjob',image_1='$newname',email='$email',send_sms='$sendsms',promotional_offer='$promotionoffer',activate='0',verified='0' where member_id=$memberid";
...
if($image_name == "" )
{
  $t->set_var("big_image", "yourdefaultimagehere.jpg");
echo "<script> alert('Select Image $imgnm')  </script>";
//exit();											//    it stops the execution
//echo  '<META http-equiv="refresh" content="0;URL=usereditprofile.php">';           
}
else
{
...
<br />-->
<h2>Update Profile</h2></center>
<form action="usereditprofile.php" id="form1" method="post" enctype="multipart/form-data">
<h1>Registration Form</h1>
<table bgcolor="#FFDBBE" cellpadding="10" cellspacing="10">
<tr><td>Member Id</td><td><input type="text"  size="30px" readonly="true" name="memberid" value="<?php echo $memberid;?>" /></td></tr>
<tr><td>First Name</td><td><input type="text" size="30px" name="first_name" value="<?php echo $fname;?>"  /></td></tr>
<tr><td>Father Name</td><td><input type="text" name="father_name" size="30px" value="<?php echo $fathername;?>" /></td></tr>
<tr><td>Surname</td><td><input type="text" name="surname" size="30px" value="<?php echo $surname;?>" /></td></tr>
...
<?php
echo "<select style='width:200px;' name='curent_status'><option>Select</option><option>Single</option><option>Divorce</option><option>Others</option>";
...
<tr><td>Mobile No</td><td><input type="text" name="mobno"  size="30px"id="mobno" onblur="mobval();"  onkeydown="return isNumeric(event.keyCode);"   value="<?php echo $mobno;?>" /></td></tr>
...
<tr><td>Taluka</td><td><input type="text" size="30px" name="taluka" value="<?php echo $taluka;?>" /></td></tr>
...
//echo "<input type="text" name='otherdistrict' /> </td></tr> "
 ...
 ?>
	...
	<tr><td>District<td ><?php 
echo "<SELECT  NAME='district' onchange='showd();' id='district' style='width:200px;'><option selected='selected'>Select</option>
...
echo "<option  value='$district'  selected='selected'>$district</option>";
 ...
 echo "</SELECT>";?>&nbsp;&nbsp;&nbsp;&nbsp;  <input size="15px" type="text" name='otherdistrict' id="otherdistrict" />  </td></tr>
...
<tr><td>Country</td><td><input type="text" name="country" size="30px" readonly="true" value="India" /></td></tr>
<tr><td>Age</td><td>
<?php
...
<tr><td>Birth Date</td><td><input type="text" name="bdate"  size="30px"  id="pd" value="<?php echo $birthdate;?>" /></td></tr>
...
echo "<option  value='$native'  selected='selected'>$native</option>";
 ...
 echo "</select>";?> &nbsp;&nbsp;&nbsp;&nbsp;  <input type="text" size="15px" name="otehrnative" id="otehrnative"  /> </td></tr>
...
<tr><td>Mother Name</td><td><input type="text" name="mname" size="30px" value="<?php echo $mname;?>"  /></td></tr> 
<tr><td>Uncle Name</td><td><input type="text" name="unclename" size="30px" value="<?php echo $unclename;?>"  /></td></tr> 
<tr><td>Religion</td><td><input type="text" name="religion" size="30px" value="<?php echo $religion;?>"  /></td></tr> 
<tr><td>Caste</td><td><input type="text" name="caste" value="Hindu" size="30px" readonly="true" /></td></tr> 
<tr><td>Sub Caste</td><td><input type="text" name="subcaste" readonly="true" size="30px" value="Jadhav"  /></td></tr> 
 <tr><td>Gotra</td><td>
 <?php
echo "<select name='gotra' style='width:200px;'><option>Select</option><option>BHARDAUJ</option>
...
<?php
echo "<select name='jobprofile' style='width:200px;'><option>Select</option><option>Trainee</option><option>Associate</option><option>Junior</option><option>Junior</option><option>Senior</option><option>Manager</option><option>Others</option>";
if($jobprofile <> "" && $jobprofile <> "NA")
{
echo "<option  value='$jobprofile'  selected='selected'>$jobprofile</option>";
}
 echo "</select>"?></td></tr>
<tr><td>Company</td><td><input type="text"  name="company" value="<?php echo $company;?>" size="30px"  /></td></tr>
...
<?php
echo "<select name='serviscetype' style='width:200px;'><option>Select</option><option>Private</option><option>Government</option><option>Semi-Govt</option><option>Owner</option><option>Business</option><option>Industry</option><option>Father-Own</option>";
...
<tr><td>Service Location</td><td><input type="text" name="service_location" size="30px"  value="<?php echo $service_location;?>" /></td></tr>
...
<tr><td>Other Remark</td><td><input type="text" name="remark" size="30px" value="<?php echo $remark;?>" /></td></tr>
...
<tr><td>Image 1</td><td><input type="file" name="img1" size="30px" value="<?php echo $newname;?>" /></td></tr>
...
<tr><td>Email</td><td><input type="text" name="email" id="email" size="30px" onblur="emailvalidate();" value="<?php echo $email;?>" /></td></tr>
