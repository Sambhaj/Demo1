...
?>
	...
	<td><input class="txtbx" type="password" name="psw" id="PasswordField" onfocus="ChangeToPassField()" value="password" OnClick="this.value=''" /></td>
...
<div align="center"  id="middlepart">
...
if($unm == $username)
{
echo "<script> alert('Username is already exist please try new one')</script>"; 
	$ok="nok";
//goto end;
//exit();
//history.back();
...
//if($activate <> "0")
//{
	//echo "<script> alert('select activate option')
...
//{
 //if($verified <> "0")
 //{
//	echo "<script> alert('select verfied option')
...
member_id,first_name,father_name,surname,created_by,current_status,address,mobile_no,landline_no,taluka,district,country,age,gender,height,birth_date,native,complex,mname,uncle_name,religion,caste,sub_caste,gotra,qualification,degree,current_job_profile,company,work_experience,service_type,service_location,annual_income,other_remark,expectation,expection_job,image_1,username,password,email,send_sms,promotional_offer,activate,verified) values('$memberid','$fname','$fathername','$surname','$createdby','$current_status','$address','$mobno','$landlineno','$taluka','$district','$country','$age','$gender','$height','$birthdate','$native','$complex','$mname','$unclename','$religion','$caste','$subcast','$gotra','$qualification','$degree','$jobprofile','$company','$experience','$sv_type','$service_location','$annualincome','$remark','$expection','$expectionjob','$newname','$username','$password','$email','$sendsms','$promotionoffer','0','0')";
	 ...
	 if (!mysql_Query($qry,$dsn))                       //check query execured or not
      ...
      {
	echo "<script> alert('Registered Successfully please login with your userid and password')</script>"; 
...
<form action="registration.php" id="form1" method="post" enctype="multipart/form-data">
<h1>&nbsp;</h1>
<table bgcolor="#FFDBBE" cellpadding="10" cellspacing="10">
<tr><td colspan="2"><span class="style1">Fields with * are mandatory.<b>Please remember username and password.</b></span>.</td>
</tr>
<tr><td>Member Id</td><td><input type="text"   size="30px"  readonly="true" name="memberid" value="<?php echo $idd;?>" /></td></tr>
<tr>
  <td>First Name*</td>
  <td><input type="text" name="first_name"   size="30px"  value="<?php echo $fname;?>"  /></td></tr>
<tr>
  <td>Father Name*</td>
  <td><input type="text" name="father_name"   size="30px"  value="<?php echo $fathername;?>" /></td></tr>
<tr>
  <td>Surname*</td>
  <td><input type="text" name="surname"   size="30px"  value="<?php echo $surname;?>" /></td></tr>
<tr><td>Created By</td><td>
<?php
echo "<select name='createdby'   style='width:200px;'><option>Select</option><option>Self</option><option>Parents</option><option>Friend</option><option>Admin</option><option>Other</option>";
...
<?php
echo "<select name='curent_status' style='width:200px;'><option>Select</option><option>Single</option><option>Divorce</option><option>Others</option>";
if($current_status <> "" && $current_status <> "NA")
{
echo "<option  value='$current_status'  selected='selected'>$current_status</option>";
}
 echo "</select>"?>    </td></tr>
<tr><td>Address</td><td> <textarea name="address" cols="23" rows="5"><?php echo $address;?></textarea> </td></tr>
<tr><td>Mobile No</td><td><input type="text" name="mobno" size="30px"  id="mobno" onblur="mobval();" maxlength="10"  onkeydown="return isNumeric(event.keyCode);"              value="<?php echo $mobno;?>" /></td></tr>
<tr><td>Landline No</td><td><input type="text" name="landlineno" size="30px"  onkeydown="return isNumeric(event.keyCode);"  value="<?php echo $landlineno;?>"/></td></tr>
<tr><td>Taluka</td><td><input type="text" name="taluka" size="30px"  value="<?php echo $taluka;?>" /></td></tr>
...
//echo "<input type="text" name='otherdistrict' /> </td></tr> "
 ...
 ?>
	...
	<tr><td>District<td >
<?php 
echo "<SELECT  NAME='district'  style='width:200px;' id='district' onchange='showd();' style='width:140px;'><option selected='selected'>Select</option>
...
echo "<option  value='$district'  selected='selected'>$district</option>";
 ...
 echo "</SELECT>";?> &nbsp;&nbsp;&nbsp;&nbsp;
 <input type="text" size="15px" name='otherdistrict' id="otherdistrict" /> </td></tr>


<tr><td>Country</td><td>
  <input size="30px" type="text" name="country"  readonly="true" value="India" /></td></tr>
<tr><td>Age</td><td>
<?php
echo "<select name='age' style='width:200px;'><option>Select</option><option>20-23</option><option>24-26</option><option>27-30</option><option>31-33</option><option>34-36</option><option>above 37</option>";
if($age <> "" && $age <> "NA")
{
...
<tr><td>Birth Date</td><td><input type="text" size="30px" name="bdate"  id="dt" value="<?php echo $birthdate;?>" /></td></tr>
<tr><td>Native</td><td>

<?php
echo "<select name='native' id='native' onchange='show();' style='width:200px;'><option>Select</option><option>Other</option>";
if($native <> "" && $native <> "NA")
{
echo "<option  value='$native'  selected='selected'>$native</option>";
}
 echo "</select>";?> &nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="otehrnative" size="15px" id="otehrnative"  /></td></tr>
<tr><td>Complex</td><td>
<?php
echo "<select name='complex' style='width:200px;'><option>Select</option><option>Fair</option><option>Wheatish</option>";
...
<tr><td>Mother Name</td><td><input type="text" size="30px"  name="mname" value="<?php echo $mname;?>"  /></td></tr> 
<tr><td>Maternal Uncle Name</td><td><input type="text" size="30px" name="unclename" value="<?php echo $unclename;?>"  /></td></tr> 
<tr><td>Religion</td><td><input type="text" name="religion" size="30px" value="Hindu"  readonly="true" /></td></tr> 
<tr><td>Caste</td><td><input type="text" name="caste" readonly="true" size="30px" value="Kunbi"  /></td></tr> 
<tr><td>Sub Caste</td><td><input type="text" name="subcaste" value="Jadhav" size="30px" readonly="true"  /></td></tr> 
 <tr><td>Gotra</td><td>
 <?php
echo "<select name='gotra' style='width:200px;'><option>Select</option>
<option>BHARDAUJ</option>
...
<?php
//echo "<select name='qualification' style='width:200px;' ><option>Select</option><option>PhD</option><option>ME</option><option>MSc</option><option>BSc</option><option>BA</option>";
//if($qualification <> "" && $qualification <> "NA")
//{
//echo "<option  value='$qualification'  selected='selected'>$qualification</option>";
//}
...
<tr><td>Degree</td><td>
<?php echo "<select  name='degree' style='width:200px;'>
<option >Select</option>
...
<?php
//echo "<select name='degree' style='width:200px;'><option>Select</option><option>Computer</option><option>Electronics</option><option>Marketing</option>";
//if($degree <> "" && $degree <> "NA")
//{
//echo "<option  value='$degree'  selected='selected'>$degree</option>";
//}
...
<?php
echo "<select name='jobprofile' style='width:200px;'><option>Select</option><option>Trainee</option><option>Associate</option><option>Junior</option><option>Junior</option><option>Senior</option><option>Manager</option><option>Lecturer</option><option>Others</option>";
if($jobprofile1 <> "")
{
echo "<option  value='$jobprofile1'  selected='selected'>$jobprofile1</option>";
 ...
 echo "</select>";?>
 &nbsp;<?php
echo "<select name='jobclass' style='width:100px;'><option>Select Class</option><option>Class I</option><option>Class II</option><option>Class III</option><option>Class IV</option>";
...
<tr><td>Company/ Institute</td><td><input type="text" size="30px" name="company" value="<?php echo $company;?>"  /></td></tr>
<tr><td>Working Experience</td><td>
<?php
echo "<select name='experience' style='width:200px;'><option>Select</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>9</option>><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option>";
...
<?php
echo "<select name='servicetype' style='width:200px;'><option>Select</option><option>Private</option><option>Government</option><option>Semi-Govt</option><option>Owner</option><option>Business</option><option>Industry</option><option>Father-Own</option><option>Farming</option>";
...
<?php
echo "<select name='annual_income' style='width:200px;'><option>Select</option><option>1-1.5</option><option>2-3</option><option>3-4</option><option>4-6</option><option>6-8</option><option>8-10</option><option>Above 10</option>";
...
<tr><td>Other Remark</td><td><input type="text" size="30px" name="remark" value="<?php echo $remark;?>" /></td></tr>
<tr><td>Expectation</td><td><textarea name="expection"  cols="23" rows="5"><?php echo $expection;?></textarea></td></tr>
<tr><td>Expected Job</td><td>
<?php
echo "<select name='expectionjob' style='width:200px;'><option>Select</option><option>Working</option><option>HouseWife</option><option>Associate in business</option><option>Government Job</option><option>Semi-Govt-Job</option><option>Business</option>";
...
<tr>
  <td>Photo </td>
  <td><input type="file" name="img1" size="30px" value="<?php echo $newname;?>" /></td></tr>
...
<tr><td>User Name</td><td><input type="text" size="30px" name="username" maxlength="10" value="<?php echo $username;?>"/> 	</td> </tr>
<tr><td>Password</td><td><input  type="password" name="password" size="30px" id="password" maxlength="8" onblur="CheckPassword();" value="<?php echo $password;?>" />Minimum 8 Alphanumeric Characters	</td></tr>
<tr><td>Confirm Password</td><td><input  type="password" name="cpassword" size="30px" maxlength="8"  />	</td></tr>
<tr>
  <td>Email*</td>
  <td><input type="text" name="email" id="email" onblur="emailvalidate();" size="30px" value="<?php echo $email;?>" /></td></tr>
<tr>
  <td>Send Sms*</td>
  <td> <input type="radio" value="yes" name="sms" size="30px"  <?php if (isset($sendsms) && $sendsms=="1") echo "checked";?>   />Yes<input type="radio" value="no" name="sms"  <?php if (isset($sendsms) && $sendsms=="0") echo "checked";?>  />No   </td></tr>
<tr>
  <td>Promotional Offer*</td>
  <td> <input type="radio" value="yes" name="offer" size="30px" <?php if (isset($promotionoffer) && $promotionoffer=="1") echo "checked";?>    />Yes<input type="radio" value="no" name="offer" <?php if (isset($promotionoffer) && $promotionoffer=="0") echo "checked";?> />No   </td></tr>
