...
<form action="deleteadmbirthday.php" id="form1" method="post">
<div style="overflow:scroll; height:700px; width:620px">
<?php 

	
$sql  = "SELECT `news_id` as nid, `headline` as hed, `news` as nws,create_date FROM `tbbirth_death`";
...
if($mnm <> "")
{
		...
		<th width='210px'>Headline</th>		
		<th width='210px'>News</th>
		<th width='90px'>News Date</th>
		</tr>";
...
while($row = mysql_fetch_array($rs))
  ...
  list($username, $message, $message_date, $create_date)=$row;
  ...
  echo "<td style='padding:5px;vertical-align:top;'>" . $create_date . "</td>"; 							   
  echo "</tr>";
  }
...
{
$qry="Delete from tbbirth_death where news_id='$value'";
  ...
  echo "<script> alert('Birth Day list Deleted Successfully')</script>"; 
