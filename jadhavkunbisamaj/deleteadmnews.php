...
<form action="deleteadmnews.php" id="form1" method="post">
<div style="overflow:scroll; height:700px; width:620px">
<?php 

	
$sql  = "SELECT `news_id` as nid, `headline` as hed, `news` as nws,create_date FROM `tblatest_news`";
...
{
$qry="Delete from tblatest_news where news_id='$value'";
  ...
  echo "<script> alert('News list Deleted Successfully')</script>"; 
