...
<form action="deleteadmtoppers.php" id="form1" method="post">
<div style="overflow:scroll; height:700px; width:620px">

<?php 

	
$sql  = "SELECT `news_id` as nid, `headline` as hed, `news`,create_date as nws FROM `tbtoppers`";
...
{
$qry="Delete from tbtoppers where news_id='$value'";
  ...
  echo "<script> alert('Toppers list Deleted Successfully')</script>"; 
