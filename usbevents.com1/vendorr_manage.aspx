<%@ Page Language="C#" MasterPageFile="~/admmaster.master" AutoEventWireup="true" CodeFile="vendorr_manage.aspx.cs" Inherits="Co_ordinator_manage" Title="Vendor Manage" %>
...
<center>
<br /><h2>Vendor Manage Form </h2><br /><br />
<table cellspacing="6">
...
<tr><td>Vendor Name</td><td><asp:DropDownList ID="co_ordinator_name" runat="server" Width="200px"><asp:ListItem>Select</asp:ListItem></asp:DropDownList></td></tr>
...
<tr><td>Cost Final</td><td><asp:TextBox id="txt_cost_final" runat="server" Width="200px" MaxLength="7" style="text-align:right"></asp:TextBox></td></tr>
<tr><td>Advance</td><td><asp:TextBox id="txt_advance" runat="server" Width="200px" MaxLength="7" style="text-align:right"></asp:TextBox></td></tr>
<tr><td>Balance</td><td><asp:TextBox id="txt_balance" runat="server" Width="200px" MaxLength="7" style="text-align:right"></asp:TextBox></td></tr>
<tr><td>Paid By</td><td><asp:DropDownList ID="ddl_paidby" runat="server" Width="200px"></asp:DropDownList></td></tr>
...
<asp:LinkButton ID="lnkrpt" Text="Report" PostBackUrl="~/report_viewer.aspx?rpt=vendor_manage.rpt" runat="server"></asp:LinkButton>
