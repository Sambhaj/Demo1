...
$pdate=$pdate1.$project_status;
 ...
 $q=mysql_query("INSERT INTO `tb_specification` (`id`, `spl_type`, `flat_type(R)`, `flat_type(C)`, `carpet_area(R)`, `flat_cost(C)`, `flat_cost(R)`, `carpet_area(C)`, `possession_date`) VALUES('$id','$spl','$rtype','$ctype','$rarea','$carea','$rcost','$ccost','$pdate')");
		...
		function GetImageExtension($imagetype)
			{
               ...
               mysql_query("INSERT INTO  tb_projectinfo(id,project_id,project_name,project_type,location,video_link,address,brochure,gym,temple,swimming_pool,school,garden,lift,club_house,security,hospital,parking) VALUES('$id','$pid','$pname','$ptype','$location','$vlink','$address','$target_path','$gym','$temple','$swimming','$school','$garden','$lift','$club','$security','$hospital','$parking')");
...
<tr>
<td>Carpet area (R)</td>
<td><input name="rarea" id="rarea"  style="width: 90%; height: 30px; border-radius: 4px;" disabled="disabled" type="text"> 
</td>
<td>Carpet area (C) </td><td><input name="carea" id="carea" style="width: 90%; height: 30px; border-radius: 4px;"  disabled="disabled" type="text">
  
</td></tr>
<tr>
<td>Cost (R)</td>
...
<div id="pdate1" style="display: none">
    ...
    <input type="text" id="pdate" name="pdate"  style="width: 90%; height: 30px; border-radius: 4px;" placeholder="Enter The Date">
</div>
