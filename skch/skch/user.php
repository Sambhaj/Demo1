...
<div class="container">
	<div class="row">
		<div class="btn-group pull-right" style=" padding: 10px;">
			<div class="dropdown">
				...
				<a href="#" onclick="$('#employees').tableExport({type:'excel',escape:'false'});"> <img src="images/download.png" width="33px"> Download</a></li>
	...
	<div class="row" style="height:80% !important;overflow:scroll;">
