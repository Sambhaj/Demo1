...
// email
define('TO_EMAIL', 'asksedna@gmail.com');
define('FROM_EMAIL', 'asksedna@gmail.com');
define('FROM_NAME', 'Email from Contact SEDNAINFOSYSTEMS');
...
define( 'SUBJECT', 'Email from Contact SEDNAINFOSYSTEMS' );

// here the redirect, when the form is submitted
define( 'ERROR_URL', 'contact.php' );
