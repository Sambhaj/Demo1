...
<div class="animsition-overlay">
  ...
  <div class="grid">
    <div class="row paddtop100">
      ...
      <div class="colw_7 spec-l-cont border-right">
        <h3>Contact Office</h3>
		<span style="color:#3385ff">Corporate Office:</span>
        <ul class="contact">
          <li>A-505, Block-1, Sarvoday Galaxy, Dombivli[W] , Thane<span><i class="fa fa-map-marker"></i></span></li>
		  <li> 217/331, Samuel Street, Masjid[W] ,Borivali, Mumbai<span><i class="fa fa-map-marker"></i></span></li>

		 <span style="color:#3385ff">Development Office:</span>
		   <li>Opp. State Bank Of India,Old Cotton Market Road,Amravati<span><i class="fa fa-map-marker"></i></span></li>

          <li> +91- 9890750803 , +91- 8425043894, +91- 8484897384 <span><i class="fa fa-phone"></i></span></li>
          <!-- <li>+1 (555) 543-4568 <span><i class="fa fa-fax"></i></span></li> -->
          <li> info@sednainfosystems.com,asksedna@gmail.com <span><i class="fa fa-envelope"></i></span></li>
