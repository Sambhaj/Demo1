...
{
    if(val==="others")
       document.getElementById('Eekda').style.display='block';
    else
       document.getElementById('ekda').style.display='none'; 
}
</script>
 ...
 <script type="text/javascript">
        function ShowHideDiv() {
			...
			var dvPassport1 = document.getElementById("ddl1");

            state.style.display = country.value == "Other" ? "block" : "none";
		    dvPassport1.style.display = country.value == "IN" ? "block" : "none";
     ...
     <div class="col-md-10">
        ...
        <tr>
		 ...
		 <tr>
           ...
           <td ><select id="country" name="country"  onchange="ShowHideDiv()" style="background-color:white;width:65%;">
	        <option value="">select</option>

        <option value="IN">India</option>
        <option value="Other">Other</option>
    </select></td>
	<td><div id="ddl1" style="display: none">State	
		 <select id="country1" name="country1" style="background-color:white;width:65%;">>
		 	        <option value="">Select</option>
...
<option value="West Bengal">West Bengal</option>
		 ...
		 <tr>
           ...
           <td ><input type="text" style="background-color:white;width:65%;"  name="state"   id="state"    value="<?php echo isset($_POST['state']) ? $_POST['state'] : ''; ?>"></td>
        </tr>
		 ...
		 <tr>
	       <td   style="font-size:16px;font-weight:;Font-family:;text-align:right"><span style="color:#DF1018;"><?php echo $req;?></span>District</td>
           <td ><input type="text" style="background-color:white;width:65%;"  name="district"   id="district"    value="<?php echo isset($_POST['district']) ? $_POST['district'] : ''; ?>"></td>
        </tr>
        ...
        <tr>
             ...
             <td >
				  <select name="ekda" style="background-color:white;width:61%;"  onchange='checkvalue(this.value)'  > 
				             <option value="">Select </option>
				...
				<td> <input type="text"  name="Eekda" id="Eekda" style='display:none'/>
       ...
       <tr>
        ...
        <tr>
          ...
          <td   style="font-size:16px;font-weight:;Font-family:;text-align:right"><span style="color:#DF1018;"><?php echo $req;?></span>Area Admin</td>
	       <td ><input type="text" style="background-color:white;width:65%;"  name="area_admin" id="area_admin" value="<?php echo "Self" ?>" readonly="readonly"></td>
