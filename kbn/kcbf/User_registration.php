   ...
   <div class="container">
    ...
    <div class="row"  >
     <div class="col-md-10">
      ...
      <center>
		<table width="65%" cellspacing="10px" cellpadding="2px" style= "border: 1px solid #a1a1a1; background-color:#f2f2f2; #ffebea; border-radius: 10px;margin:50px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.19)">
		<tr><th colspan="4" style="height:65px;background-color:#146b85;color:white;font-size:22px;font-weight:bold;border-radius:10px">REGISTRATION FORM</th>
		</tr>
