     ...
     <div class="col-md-10">
        ...
        <center> <table width="30%" height="50%" cellspacing="10px" cellpadding="5px" style= "border: 1px solid #a1a1a1; background-color:#f2f2f2; #ffebea; border-radius: 10px;margin:50px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.19)">
			...
			<tr><td style="padding:5px;font-size:18px;;"><span style="color:#DF1018;"><?php echo $msg;?></span><span style="color:green;"><?php echo $sucss;?></span></td></tr>
             ...
             <tr><td ><input type="text" style="background-color:white;width:95%;height:25px;padding:4px"   name="name" id="name"  placeholder="Enter Your Name"  value="<?php echo isset($_POST['name']) ? $_POST['name'] : ''; ?>"></td>
             <tr><>
             <tr><span style="color:#DF1018;"><?php echo $req;?></span>Mobile No.</tr>
          ...
          <td  style="padding:15px;align:center" ><input type="submit" onclick="resetform()" class="utt10" id="btn" value="Submit" name="submit"></td></tr>
