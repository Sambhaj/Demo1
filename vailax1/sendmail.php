...
// email
define('TO_EMAIL', 'neha@sednainfosystems.com');
define('FROM_EMAIL', 'neha@sednainfosystems.com');
define('FROM_NAME', 'Email from Project SEDNA');
 ...
 * email: %email%   
 */ 
define( 'BODY', '%message%<br /><br /><span>email send by %name%, email %email%, tel.: %phone%.</span>' );
define( 'SUBJECT', 'Email from Project SEDNA' );

// here the redirect, when the form is submitted
define( 'ERROR_URL', 'contact_us.html' );
define( 'SUCCESS_URL', 'contact_us.html' );
define( 'NOTSENT_URL', 'contact_error.html' );
