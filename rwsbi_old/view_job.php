		...
		function GetImageExtension($imagetype)
			...
			if (!empty($_POST["desc"]))
			{
				...
				move_uploaded_file($temp_name, $target_path); 
					...
					mysql_query("INSERT into tb_docs_job (id,description,doc,link) values('','$desc','$target_path','$lk') ") or die(mysql_error());	 
...
<div class="container-fluid"  style="background-color:#015070">
          ...
          <form method="POST" action="" enctype="multipart/form-data"> 
		         <center> <table style="border-radius: 20px;width:50%;background-color:#99b3ff;" >
                  ...
                  <a href="view_job.php"><input type="button" id="btn" name="View" style="color:#ffffff;background-color:#015070" value="View" > </a>		
		          </td>
		          </tr>
		 		</table> </center>
    ...
    <thead>
        ...
        <tr  >
            <?php $result = mysql_query("SELECT * FROM tb_docs_job") or die(mysql_error()); 
            $row_count = 1;
...
?>
    ...
    <a href="delete2.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this  ?')" name="delete"><img src="images/delete_icon.png"></a>
