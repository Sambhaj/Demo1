            ...
            <div class="sl-slide item1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                <div class="sl-slide-inner">
                    <div class="container">
                        ...
                        <h2>The bank for a changing world</h2>
        ...
        <div class="row-fluid">
            <div class="span8">
                ...
                <p class="no-margin">"Ravi Wakode Sir’s Banking & Educational Institute" (RWSBI) has started from October, 2010 in renowned Amravati city from Maharashtra State directed by Mr. Ravikumar Niranjan Wakode.
                    <br><br>
                 Institute is recognized for his Aggressive Excellence and Imparting a triumph caliber for banking examination as well as CMAT for MBA aspirant student also for MPSC/UPSC [CSAT] and LIC, SSC.</p>
            </div>
            <div class="span4">
                <img style="border:2px solid #B5B4B2;height:250px" src="images/image_01.jpg" alt="">
            </div>
        </div>
    </div>
</section>
