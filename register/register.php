...
<form method="post" action="" enctype="multipart/form-data">
	...
	<table align="center" class="demo-table" style="border:2px solid black;padding:5px;width:500px">
		...
		<b>NOTE: </b> a) Submission of form or clearance of cheque ,no way ,can be construed you as a &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;member  unless the Managing Committee in it’s meeting approve your name.
