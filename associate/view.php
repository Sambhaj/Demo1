...
<!----Start Main Contents---------->
 ...
 <form method="POST" action="" enctype="multipart/form-data"> 
		...
		<input type="submit" name="View" style="color:#000000;" value="view" > 
		</td>
		</tr>
		 <br>
		</table> </center>
		</form><br><center><span style="color:#DB5353;font-weight:bold;"><?php echo $blanck; ?></span><span style="color:#00264d;font-weight:bold;"><?php   echo $succes;?></span></center><br>
          <center><table style="border:radius 20px;padding:20px" width="50%">
    <thead>
        ...
        <tr  style="border:1px solid white;">
			...
			<th style="align:center;color:white">&nbsp;Link</th>
			<th style="align:center;color:white">&nbsp;Action</th>
        </tr>
    </thead>
    <tbody>
<?php 
