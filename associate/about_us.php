...
<div class="row">
<div class="col-sm-9"><p style="font-size:13px;text-align:justify;"><span style="font-size:16px;color:#023A5C;">Welcome to <b>Jagdish B. Shah & Associates</b></span><br><br>We, M/s. Jagdish B. Shah & Associates, Chartered Accountants have been servicing our clients
from 1964. The firm currently has two partners, <b>Mr. Jagdish B. Shah</b> and <b>Mrs. Urvi M. Shah.</b><br><br>

We have well trained and experienced personnel proficient in all aspects of our
assignments supported by the most modern and sophisticated infrastructure.<br><br>
Our teams of highly skilled and motivated personnel have gained in-depth experience in
providing multitude of services, ranging from tax planning to representative office. </p>
<br>
<span style="font-size:14px;font-weight:bold">PARTNERS PROFILE</span><br><br>
 
 
<div class="row">
<div class="col-sm-2" style="text-align:center; "><img src="images/jagdish_shah.jpg" style="border-radius: 50%;
	border:1px solid #023A5C;width:80px;"></div>
<div class="col-sm-10" style="font-size:13px;text-align:justify;">1. <b>CA. Jagdish B. Shah, B.Com., FCA<br>
Mr. Jagdish B. Shah,</b> is the founder partners, was enrolled as a member of the Institute of
Chartered Accountants of India in 1964 and has an experience of 5 decades in almost every
facet of the accounting, auditing and consulting profession. He is a meticulous professional who
is well versed in tax laws, commercial laws, company law, accounting and auditing standards,
management consultancy, mergers and acquisitions, representative offices etc. and providing
services to the wide spectrum of clientele of the firm.</div>
</div><br>
<div class="row">
<div class="col-sm-2" style="text-align:center;"><img src="images/urvi.png" style="border-radius: 50%;
	border:1px solid #023A5C;width:80px;"></div>
<div class="col-sm-10" style="font-size:13px;text-align:justify;">2 . <b>CA. Urvi M. Shah, B.Com., FCA, LLB(Gen.), DISA<br>
Mrs. Urvi Shah,</b> qualified as a Chartered Accountant in the year 2003, has started her
professional career from this firm. Her forte lies in audit and assurance, direct as well as indirect
taxation, corporate law, consultancy, etc.</div>
</div> 
</div>

<div class="col-sm-3" id="sidebar" style="background:#F0F0F0; ">
 <img src="images/taxban.jpg"  class="img-responsive">
 </div>
 <div class="col-sm-3" id="sidebar"   style="background:#F0F0F0;height:250px; ">
  <marquee direction="up" scrolldelay="300" width="100%" height="100%" scrollamount="11" onmouseover="this.stop();" onmouseout="this.start();" >
  <ul>
 <?php 
...
<span class="glyphicon glyphicon-envelope" style="color:#FFFFFF;"></span> &nbsp; jbshah@cajbshahassociates.com<br>
  ...
  <div class="col-md-3"><h3>Map</h3><p><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3772.487665493675!2d72.8251982149!3d18.998220987132584!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7cec3f462dfbd%3A0x8f317d1b39e5e5ce!2sSenapati+Bapat+Marg%2C+Lower+Parel%2C+Mumbai%2C+Maharashtra!5e0!3m2!1sen!2sin!4v1470383200581" width="100%" height="170px" frameborder="0" style="border:0" allowfullscreen></iframe></p>
 </div>
  </div>
   </div>
   </div>
