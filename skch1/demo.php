...
<body>
<div class="col-md-12"  >
<center><img src="images/logo-2.jpg" ></center>
</div>
...
<tr><td> Flat type </td><td>
 <select  name="rtype" id="rtype" onChange="window.open('demo1.php?src=' + document.dropform.dropdown.options[document.dropform.dropdown.selectedIndex].value, 'largerImage', 'height=500, width=620, top=20, left=250, toolbar=no, menubar=no, location=no, resizable=no, scrollbars=no, status=no')">
