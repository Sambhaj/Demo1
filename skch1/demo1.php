...
?>
	...
	if (isset($_REQUEST['id'])) {
		...
		$pname="";
		$id = intval($_REQUEST['serial_no']);
		$qr = "SELECT * FROM tbmember_registration WHERE serial_no=$id";
echo"$id";
...

{
  ...
  /* 
	...
	$a=mysql_query("INSERT INTO tb_business(card_name,name,email,phone,message) VALUES('$dataName','$name','$email','$phone','$message')");
	echo"$a";
