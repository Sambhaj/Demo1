...
$Product_Presentations=$_POST['Product_Presentations'];
$General_Session=$_POST['General_Session'];
$jan=$Product_Presentations."-".$General_Session;
        ...
        <label style="padding-left:200px">CONFERENCE DETAILS</label>
          ...
          <div class='form-group'>
            ...
            <div class='col-md-8' >
              <div class='col-md-5'>
                <div class='form-group internal' >
                 <input  type='checkbox' value='22nd January 2018 ' name="dinner" required="required" id="event" > 22<sup>nd</sup> January 2018 <br>
				  &nbsp;&nbsp;&nbsp;&nbsp;<input  type='checkbox' value='Product Presentations' name="Product_Presentations" required="required" id="event" >  Product Presentations <br>
				  &nbsp;&nbsp;&nbsp;&nbsp;<input  type='checkbox' value='General Session' name="General_Session" required="required" id="event" > General Session<br>
                </div>
              </div>
			  <div class='col-md-5'>
                <div class='form-group internal'>
				    <input  type='checkbox' value='23rd January 2018 Product Presentations' name="booking" required="required" id="event"> 23<sup>rd</sup> January 2018 <br>&bull; Product Presentations
                </div>
              </div>
