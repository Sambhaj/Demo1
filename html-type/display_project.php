		...
		if($valueToSearch1 <> "" && $valueToSearch1 <> "NA")
{
 ...
 <td></td> <td></td>
					...
					<img src="images/tanishka2.jpg" width="50%" height="auto" data-toggle="modal" data-target="#view-modal" data-id="<?php echo $row['id']; ?>" id="getUser" class="button" >
                         					     ...
                         					     <td><?php echo $row['flat_cost_R']; echo $row['flat_cost_C'];?></td>

					   <td><?php echo $row['spl_type'];?></td>
					    <td><?php echo $row['carpet_area(R)'];?></td>
					...
					<tr>
                     ...
                     $post = substr($message, 0, $position); 
						...
						<?php echo "<a href=$row[5]  style='font-size:13px;font-weight:bold;  target='_blank''>$post</a>";?>
