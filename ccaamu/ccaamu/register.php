...
<form method="post" action="" enctype="multipart/form-data">
	...
	<table align="center" class="demo-table" style="border:2px solid black;padding:5px;width:500px">
		...
		<tr>
			...
			<td><input type="radio" class="demoInputBox" name="marital_status" value="Married" >Married
			<input type="radio" class="demoInputBox" name="marital_status" value="Unmarried" >Unmarried</td>
		</tr>
		<tr>
			<td>Date of Marriage Anniversary </td>
			<td><input type="text" id="InputBox" class="tcal" name="date_anni" placeholder="dd/mm/yy"  value=""/></td>
		</tr>
		<tr>
			<td>Blood Group  </td>
