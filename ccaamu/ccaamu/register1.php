...
$Sr_no="form";
$rowSQL = mysql_query( "select MAX($Sr_no)from ccaamu_register;" );
...
$new_id=$largestNumber+1;
 ...
 $m_no="member";
/*  $rowSQL = mysql_query( "select MAX($m_no)from ccaamu_register;" );
 */ $row_count=mysql_query("SELECT *FROM ccaamu_register");
$row = mysql_fetch_array( $row_count );
 $largestNumber = $row[1];
 if($largestNumber==0)
 {
	 $member_no=101;
...
<form method="post" action="" enctype="multipart/form-data">
	...
	<table align="center" class="demo-table" style="border:2px solid black;padding:5px;width:500px">
		...
		<tr>
			<td>Membership No</td>
			<td><label>MH/CCAA/<?php echo $member_no;?></label></td>
		</tr>
		<tr>
			<td>Name</td>
