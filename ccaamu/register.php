...
$Sr_no="form";
$n="";
$rowSQL = mysql_query( "select MAX($Sr_no)from tb_register;" );
...
$new_id=$largestNumber+1;
 ...
 $m_no="member";
 $id="";
$new = mysql_query( "select MAX($m_no)from tb_register" );
...
function landline1()
{
  ...
  <script type="text/javascript">
    function ShowHideDiv() {
        var chkMarried = document.getElementById("chkMarried");
        var dvanny = document.getElementById("dvanny");
        dvanny.style.display = chkMarried.checked ? "block" : "none";
    }
</script>
...
<form method="post" action="" enctype="multipart/form-data">
	...
	<table align="center" class="demo-table" style="border:2px solid black;padding:5px;width:500px">
		...
		<tr>
			<td>Form No.</td>
			<td><label>F/17/<?php echo $new_id;?></label></td>
		</tr>
		<tr>
			<td>Membership No</td>
			<td><label>MH/CCAA/<?php echo $id;?></label></td>
		</tr>
		<tr>
			<td>Name</td>
        ...
        <input type="radio" id="chkMarried" name="marital_status"  value="Married" onclick="ShowHideDiv()" />Married
        </label>
       <label for="chkunmarried">
        <input type="radio" id="chkunmarried" name="marital_status" value="Unmarried" onclick="ShowHideDiv()" />UnMarried
		...
		<tr>
			...
			<td>   <input type="text" id="dvanny"  class="tcal" name="date_anni" placeholder="dd/mm/yy" /></td>
		</tr>
		<tr>
			<td>Blood Group  </td>
