    ...
    <div class="row"  >
     <div class="col-md-10">
        ...
        <tr>
          ...
          <tr>
             <td  style="font-size:16px;font-weight:;Font-family:;text-align:right"><span style="color:#DF1018;"><?php echo $req;?></span>Country</td>
             <td >
			 <select id="country" name="country" style="background-color:white;width:66%;height:22px;"></select>
		 ...
		 <tr>
             <td  style="font-size:16px;font-weight:;Font-family:;text-align:right"><span style="color:#DF1018;"><?php echo $req;?></span>State</td>
             <td >
					<select name="state" id="state" style="background-color:white;width:66%;height:22px;"></select>
		     </td>
        </tr>
		
        <tr>
	          <td   style="font-size:16px;font-weight:;Font-family:;text-align:right"><span style="color:#DF1018;"><?php echo $req;?></span>City</td>
	          <td ><input type="text" style="background-color:white;width:65%;"  name="city" id="city" value="<?php echo isset($_POST['city']) ? $_POST['city'] : ''; ?>"></td>
        </tr>
         <tr>
        ...
        <tr>
		   ...
		   <tr>
             ...
             <td ><select name="ekda" style="background-color:white;width:66%;height:22px;">
 ...
 Business (Self-Employed)
   ...
   Service
        ...
        <tr>
		 ...
		 <tr>
             <td  style="font-size:16px;font-weight:;Font-family:;text-align:right"><span style="color:#DF1018;"><?php echo $req;?></span>Nature Of Business</td>
            <td><select id="nature_of_business" name="nature_of_business" style="background-color:white;width:66%;height:22px;"></select>
		     <script language="javascript">
	    ...
	    <tr>
             <td  style="font-size:16px;font-weight:;Font-family:;text-align:right"><span style="color:#DF1018;"><?php echo $req;?></span>Specific Details</td>
             <td >
					 <select   name="specific_details" id="specific_details" style="background-color:white;width:66%;height:22px;">
        ...
        <tr>
             <td  style="font-size:16px;font-weight:;Font-family:;text-align:right"><span style="color:#DF1018;"><?php echo $req;?></span>Designation</td>
