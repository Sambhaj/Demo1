...
<html lang="en-US">
    ...
    <head>
        ...
        <title>Members Sheet | THE MAHARASHTRA BELTS &amp; HOSES TRADERS ASSOCIATION</title>
...
<!-------------Your contents body---------------------->	
		...
		<li class='active'><a href='Members_Sheet.php'><span>Members Sheet</span></a></li>
		...
		<center><br><br><br><input type="submit" value="Generate Members Sheet" onclick="parent.location='Data_Entry_View.php'"></center>
		</div>
