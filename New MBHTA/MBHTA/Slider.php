...
<html lang="en-US">
    ...
    <head>
        ...
        <title>Slider | THE MAHARASHTRA BELTS &amp; HOSES TRADERS ASSOCIATION</title>
...
<!-------------Your contents body---------------------->	
		...
		<li class='active' ><a href='Slider.php'><span>Slider</span></a></li>
		...
		<table>
		<tr>
		<td colspan="2" align="center" style="border-bottom:1px #272727 solid; text-align:center;font-size:16px;padding:10px;background-color:#38A3E1;font-family: 'roboto';color:#FFFFFF;">Upload New Slide
		</td>
		</tr>
		<tr>
		<td bgcolor="#F9F9F9" style="padding:20px;" align="center">
			<table border="0" >
			<form method="POST" action="Load.php" enctype="multipart/form-data"> 
			<td style="width:40%;padding:20px;"><b style="float:right;"><b style="color:red;"><sup>* </sup></b>Upload Image:</b></td>
			<td>
			<input name="uploadedimage" type="file" style="width:60%;">
			</td> 
			</tr> 
			<tr>
			<td></td> 
			<td><button name="submit" value="Submit" style="height:30px;">Upload</button></td>
			</tr> 
			</form> 
			</table>
		</td>
		...
		<table>
		<tr>
		<td style="border-bottom:1px #272727 solid; text-align:center;font-size:16px;padding:10px;background-color:#38A3E1;font-family: 'roboto';color:#FFFFFF;">ID
		</td>
		<td style="border-bottom:1px #272727 solid; width:80%;text-align:center;font-size:16px;padding:10px;background-color:#38A3E1;font-family: 'roboto';color:#FFFFFF;">Slides
		</td>
		<td style="border-bottom:1px #272727 solid; text-align:center;font-size:16px;padding:10px;background-color:#38A3E1;font-family: 'roboto';color:#FFFFFF;">Action
		</td>
		</tr>
		</table>
		<object type='text/html' data='Remove.php' width='100%' height='400' style='overflow: scroll;'></object>
		</div>
