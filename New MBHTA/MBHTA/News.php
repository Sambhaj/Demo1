...
if(isset($_POST['submit']))
	{
		function GetImageExtension($imagetype)
			...
			if (!empty($_FILES["uploadimage"]["name"])&&!empty($_POST["head"])&&!empty($_POST["desc"]))
			{
				// for data upload
				$head = $_POST['head']; 
				$desc = $_POST['desc']; 
				...
				{
					mysql_query("INSERT into news (Headlines,Details,Image) values('$head','$desc','$target_path') ") or die(mysql_error());
...
<html lang="en-US">
    ...
    <head>
        ...
        <title>News | THE MAHARASHTRA BELTS &amp; HOSES TRADERS ASSOCIATION</title>
...
<!-------------Your contents body---------------------->	
		...
		<table>
		<tr>
		<td colspan="2" align="center" style="border-bottom:1px #272727 solid; text-align:center;font-size:16px;padding:10px;background-color:#38A3E1;font-family: 'roboto';color:#FFFFFF;">Add News
		</td>
		</tr>
		<tr>
		...
		<td>
		<span style="color:red;"><?php echo $msg;?></span><input style="width:60%;" name="uploadimage" type="file">
		</td>
		</tr>
		<tr>
		<td>
		...
		<td style="border-bottom:1px #272727 solid; width:95%;text-align:center;font-size:16px;padding:10px;background-color:#38A3E1;font-family: 'roboto';color:#FFFFFF;">News
		</td>
		</tr>
		</table>
		<object type='text/html' data='Update_Remove_News.php' width='100%' height='400' style='overflow: scroll;'></object>
		</div>
