...
<link href='https://fonts.googleapis.com/css?family=Exo+2:400,700' rel='stylesheet' type='text/css'>
	...
	<div style="height:35px;">
		<p style="color:white;margin-top:5px;padding:5px;text-align:center;font-size:18px"><b>Circulars
		</b></p>
	</div>
<!-------------End Admin Header---------------------->  
...
<!-------------Your contents body---------------------->			
	...
	<?php 
					...
					while($r=mysql_fetch_row($query_parent))
					{
						...
						echo "<table>";
	echo "<tr>";
	echo "<td  style='font-size:16px;text-align:justify;width:94%'>";
	echo "<b>$r[1]</b><br><br>$r[2]<br>";
	echo "</td>";
	echo "<td style='text-align:center;'><a href='Download.php?nama=".$r[3]."'><img src='images/download.png' alt='Download' style='width:40px;height:40px;'><br>Download</a></td>";
	echo "</tr>";
	echo "</table>";
					}
	?>
