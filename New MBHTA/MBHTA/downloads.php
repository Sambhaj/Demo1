...
<link href='https://fonts.googleapis.com/css?family=Exo+2:400,700' rel='stylesheet' type='text/css'>
	...
	<div style="height:35px;">
		<p style="color:black;margin-top:5px;padding:5px;text-align:center;font-size:18px"><b>Circulars	</b></p>
	</div>
<!-------------End Admin Header---------------------->  
...
<!-------------Your contents body---------------------->			
	...
	<?php
		...
		$query_parent=mysql_query("Select * from circulars") or die("Query failed: ".mysql_error());
        while($r=mysql_fetch_row($query_parent))
         {
                
				echo "<div style='float:left; padding-left:28px;padding-right:28px;'>";
				echo "<a href='Download.php?nama=".$r[3]."'><img src='images/downloads-icon.png' alt='Download' style='width:100px;height:80px;'></a><br>"; 
				echo "<p style='width:300px;text-align:center;text-transform:Uppercase;font-size:15px;'><b>$r[1]</b></p><br>";
				echo "<p style='width:300px;text-align:justify;'>$r[2]</p>";
