...
<link href='https://fonts.googleapis.com/css?family=Exo+2:400,700' rel='stylesheet' type='text/css'>
	...
	<div style="height:35px;">
		<p style="color:white;margin-top:5px;padding:5px;text-align:center;font-size:18px"><b>Latest News
		</b></p>
	</div>
<!-------------End Admin Header---------------------->  
...
<!-------------Your contents body---------------------->			
	...
	<?php
		...
		$query_parent=mysql_query("Select * from news") or die("Query failed: ".mysql_error());
        while($r=mysql_fetch_row($query_parent))
         {
                
				echo "<div style='float:left; padding-left:28px;padding-right:28px;'>";
				echo "<img src='$r[3]' style='width:300px;height:150px;'><br>";
				echo "<p style='width:300px;text-align:center;text-transform:Uppercase;font-size:18px;'><b>$r[1]</b></p>";
