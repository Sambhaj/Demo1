...
<?php
	...
	if(count($_POST)>0) 
	{
	$conn = mysql_connect("localhost","root",""); // connection to the server
	mysql_select_db("Gov",$conn); // conection to database


	$result = mysql_query("SELECT * FROM admin WHERE BINARY Admin_Name='" . $_POST["name"] . "' and BINARY Password = '". $_POST["password"]."'");
...
<html lang="en-US">
    ...
    <head>
        ...
        <title>Admin Login | THE MAHARASHTRA BELTS &amp; HOSES TRADERS ASSOCIATION</title>
...
<link href='https://fonts.googleapis.com/css?family=Exo+2:400,700' rel='stylesheet' type='text/css'>
	...
	<div style="height:35px;">
		<p style="color:white;margin-top:5px;padding:5px;text-align:center;font-size:18px"><b>Admin Login
		</b></p>
	</div>
<!-------------End Admin Header---------------------->  
...
<div id="primary" class=" col-md-12 full-width col-single">
	...
	<center>
		...
		<div class="message" style="margin-top:15px; width:295px;">
		
		<table  align="center" >
		<tr  border="1">
		<td colspan="2" width="100" height="30" bgcolor="white"><a href="http://www.beltshoses.in/"><img src="images/close.png" style="float:right;width:40px;height:40px;"></a></td>
		</tr>
		<tr  border="1">
		<td colspan="2" width="100" height="30" bgcolor="white"><center><b style="font-size:18px;">Login to your Account</b></center></td>
		</tr>
		<tr bgcolor="#E5EDF2">
		<td align="right" border="2" height="30"><img src="images/admin1.png" style="width:30px;height:30px;float:right;"></td>
		<td width="100" height="30"><input type="text" name="name" class="tx" placeholder=" Username"></td>
		</tr>
		<tr bgcolor="#E5EDF2">
		<td align="right" height="30" style="border-bottom:3px solid #FFFFFF;" ><img src="images/pass1.png" style="width:30px;height:30px;float:right;"></td>
		<td width="100" height="30" style="border-bottom:3px solid #FFFFFF;"><input type="password" name="password" class="tx" placeholder=" Password"></td>
		</tr>
		<tr bgcolor="#E3E3E3">
		<td   bgcolor="#E3E3E3"></td>
		<td   align="right" width="100" height="30" bgcolor="#E3E3E3" style="padding:5px;"><button name="submit" value="submit" style="height:30px;">Login</button><span style="float:right;margin-top:14px;text-decoration: underline;"><a href="Forget_Pass.php">Forget Password</a></span></td>
		</tr>
		<tr>
		<td colspan="2" style="color:red; font-size:12px;padding:5px;"><center><?php if($message!="") { echo $message; } ?></center></td>
		</tr>
		</table>
		</div>
		</form>
