...
define('FROM_NAME', 'Email from Project vailax');
 ...
 * email: %email%   
 */ 
define( 'BODY', '%message%<br /><br /><span>email send by %name%, email %email% </span>' );
define( 'SUBJECT', 'Email from Project SEDNA' );

// here the redirect, when the form is submitted
define( 'ERROR_URL', 'Mailnotsend.php' );
define( 'SUCCESS_URL', 'Mailsend.php' );
define( 'NOTSENT_URL', 'Mailnotsend.php' );
