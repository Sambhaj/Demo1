...
// email
define('TO_EMAIL', 'sednainfo5@gmail.com');
define('FROM_EMAIL', 'sednainfo5@gmail.com');
...
define( 'SUBJECT', 'Email from Project vailax' );

// here the redirect, when the form is submitted
define( 'ERROR_URL', 'index.html' );
define( 'SUCCESS_URL', 'contact_us.html' );
define( 'NOTSENT_URL', 'service.html' );
