...
<SELECT  name="etype1" id="ddlPassport123"  style="width: 170px;height:25px" onchange='CheckColors1(this.value);' >
...
<!--<SELECT  name="etype1" id="etype" style="width: 170px;height:25px">
  <option selected='selected'>Select</option>
  <option>Insurance Company</option>
  <option>Insurance Broker</option>
  <option>Insurance Agent</option>
  <option>Company</option>
  <option>Non-Profit Entity</option>
  <option>Individual</option>
  <option>Government Entity</option>
  <option>Other</option>
  
</select>-->
<SELECT  name="etype1" id="ddlPassport123"  style="width: 170px;height:25px" onchange='CheckColors(this.value);' >
  <option value="Select">Select</option>
  <option value="Insurance Company">Insurance Company</option>
  <option value="Insurance Broker">Insurance Broker</option>
  <option value="Insurance Agent">Insurance Agent</option>
