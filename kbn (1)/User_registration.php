   ...
   <div class="container" >
				...
				<table  style="padding-top:10px 12px 12px 12px;width:100%">
					  <tr><td Align="right" width="50px" >
                        ...
                        <td>REGISTRATION FORM</td>
						  <td Align=right ><a href="index.html" data-toggle="tooltip" title="Back"><img src="images\13.png" height="30px" style=""></a></td>
					  </tr>
				 </table>
           </div>
		</div>
    <div class="row"  >
     <div class="col-md-10">
      ...
      <center>
		<table width="65%" cellspacing="10px" cellpadding="2px" style= "border: 1px solid #a1a1a1; background-color:#ffae00; border-radius: 10px;margin:50px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.19)">
		<tr style="height:65px;background-color:#ffae00;"><th colspan="4" style="height:65px;background-color:#ffae00;color:white;font-size:22px;font-weight:bold;border-radius:10px">REGISTRATION FORM</th>
		</tr>
		...
		<tr></tr>
		<tr><td colspan="4" style="font-weight:bold;font-size:21px;text-align:left;">Personal Information</td></tr>
		<tr>

		    <td style="font-size:16px;visibility: hidden;width:23%"><span style="color:#DF1018;"><?php echo $req;?></span> Serial No</td>
	        <td style="width:40%"><input type="text" style="background-color:white;height:22px;width:60%;visibility: hidden;"  name="serial_no" id="serial_no"  value="<?php echo @$new_id;?>"readonly="readonly"></td>
            <td></td>
			<td></td>
		</tr>
		 <tr>
		    <td style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Name<span style="color:red">    *</span></td>
            <td ><input type="text"  style="background-color:white;height:22px;width:60%;" required="required"   name="name" id="name"    value="<?php echo isset($_POST['name']) ? $_POST['name'] : ''; ?>"></td>
	        <td  style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Address<span style="color:red">    *</span</td>
            <td rowspan="2"><textarea  style="background-color:white;width:100%;height:57px;" required="required"  name="address" id="address" value="<?php echo isset($_POST['address']) ? $_POST['address'] : ''; ?>"></textarea ></td>
        </tr>
		<tr>
		    <td   style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>City<span style="color:red">    *</span></td>
	        <td ><input type="text" style="background-color:white;width:60%;height:22px;"  name="city" required="required" id="city" value="<?php echo isset($_POST['city']) ? $_POST['city'] : ''; ?>"></td></tr>
		 <tr>
             <td style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Country</td>
             <td style="width:40%">
			 <select id="country" name="country" style="background-color:white;height:28px;width:62%"></select>
		     <script language="javascript">
                    populateCountries("country", "state");
                    
             </script> 
			 </td>
			 <td style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>State</td>
             <td >
				<select name="state" id="state" style="background-color:white;width:105%;height:28px;"></select>
		     </td>
			 
		</tr>

		 <tr>
     		 <td   style="font-size:16px;">  <span style="color:#DF1018;"><?php echo $req;?></span>Email<span style="color:red">    *</span</td>
             <td ><input type="text"   style="background-color:white;width:60%;height:22px;"  name="email" required="required" onblur="emailvalidate();" id="email"   value="<?php echo isset($_POST['email']) ? $_POST['email'] : ''; ?>"></td>
             <td   style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Pincode</td>
             <td ><input type="text" style="background-color:white;width:102%;height:22px;"  name="pincode"   id="pincode"    value="<?php echo isset($_POST['pincode']) ? $_POST['pincode'] : ''; ?>"></td>
          
		</tr>
		<tr>
             <td style="font-size:16px;">   <span style="color:#DF1018;"><?php echo $req;?></span>Landline No</td>
             <td ><input type="text"   placeholder="" style="background-color:white;height:22px;width:60%"  onblur="landval()" name="landline_no" id="phno"    value="<?php echo isset($_POST['landline_no']) ? $_POST['landline_no'] : ''; ?>"></td>
             <td style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Mobile No<span style="color:red">    *</td>
             <td ><input type="text"    style="background-color:white;width:102%;height:22px;" onblur="mobval();" required="required" name="mobile_no"  id="mobno"  value="<?php echo isset($_POST['mobile_no']) ? $_POST['mobile_no'] : ''; ?>"></td >
	 
        </tr>
		 <tr>  
              <td  style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Birth Date<span style="color:red">    *</span</td>
	          <td ><input type="text" style="background-color:white;width:52%;height:22px;" required="required"  class="tcal" placeholder="DD/MM/YYYY" name="birth_date" id="datepicker" value="<?php echo isset($_POST['birth_date']) ? $_POST['birth_date'] : ''; ?>"></td>
		      <td  style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Ekda</td>
              <td ><select name="ekda" style="background-color:white;width:105%;height:28px;">
		...
		<tr><td colspan="4" style="font-weight:bold;font-size:21px;text-align:left;">Trade Information</td></tr>
		<tr></tr>
		<tr></tr>
		<tr></tr>
		<tr> 
		    <td  style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Name<span style="color:red">    *</span</td>
            <td><input type="text" style="background-color:white;width:60%;height:22px;"  name="trade_name" required="required" id="trade_name"  value="<?php echo isset($_POST['trade_name']) ? $_POST['trade_name'] : ''; ?>"></td>
            <td  style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Address<span style="color:red">    *</span</td>
            <td rowspan="2" ><textarea  style="background-color:white;width:100%;height:57px;" required="required"  name="trade_address" id="trade_address" value="<?php echo isset($_POST['trade_address']) ? $_POST['trade_address'] : ''; ?>"></textarea ></td>
    
		</tr>
		 <tr >
		    <td style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Type</td>
            <td colspan="3">
		...
		<tr>
            <td  style="font-size:16px;width:24%"><span style="color:#DF1018;"><?php echo $req;?></span>Nature Of Business</td>
            <td><select id="nature_of_business" name="nature_of_business" style="background-color:white;width:62%;height:28px;"></select>
		     <script language="javascript">
                    populateCountries1("nature_of_business", "specific_details");
                    
             </script> 
			</td>
			<td  style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Location</td>
            <td ><input type="text" style="background-color:white;width:102%;height:22px;"   name="trade_location" id="trade_location" value="<?php echo isset($_POST['trade_location']) ? $_POST['trade_location'] : ''; ?>"></td>

			
        </tr>
	      <tr>
		    <td  style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Specific Details</td>
            <td >
					<select name="specific_details[]" multiple="multiple" id="specific_details" style="background-color:white;width:62%;height:65px;"></select>
		    
			</td>
             <td   style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Pincode</td>
             <td ><input type="text" style="background-color:white;width:102%;height:22px;"  name="trade_pincode" id="trade_pincode"     value="<?php echo isset($_POST['trade_pincode']) ? $_POST['trade_pincode'] : ''; ?>"></td>
        </tr>
		 <tr>
             
	         <td   style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Email<span style="color:red">    *</span</td>
	         <td ><input type="text" style="background-color:white;width:60%;height:22px;"  name="trade_email" required="required" onblur="emailvalidate1()" id="email1" value="<?php echo isset($_POST['trade_email']) ? $_POST['trade_email'] : ''; ?>"></td>
	         <td  style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Designation</td>
	         <td ><input type="text" style="background-color:white;width:102%;height:22px;"  name="trade_designation" id="trade_designation" value="<?php echo isset($_POST['trade_designation']) ? $_POST['trade_designation'] : ''; ?>"></td>
		</tr>
		 <tr>
	         <td  style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Mobile 1<span style="color:red">    *</span</td>
	         <td ><input type="text" style="background-color:white;width:60%;height:22px;" onblur="mobval2();" required="required" name="trade_mobile_1" id="mobno2" value="<?php echo isset($_POST['trade_mobile_1']) ? $_POST['trade_mobile_1'] : ''; ?>"></td>
	         <td   style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Mobile 2</td>
	         <td ><input type="text" style="background-color:white;width:102%;height:22px;" onblur="mobval2();" name="trade_mobile_2" id="mobno2" value="<?php echo isset($_POST['trade_mobile_2']) ? $_POST['trade_mobile_2'] : ''; ?>"></td>
	    </tr>
		<tr>
	         <td   style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Website</td>
	         <td ><input type="text" style="background-color:white;width:60%;height:22px;"  name="trade_website" id="trade_website" value="<?php echo isset($_POST['trade_website']) ? $_POST['trade_website'] : ''; ?>"></td>
		     <td   style="font-size:16px;"><span style="color:#DF1018;"><?php echo $req;?></span>Description</td>
		     <td ><input type="text" style="background-color:white;width:102%;height:22px;"  name="trade_description" id="trade_description" value="<?php echo isset($_POST['trade_description']) ? $_POST['trade_description'] : ''; ?>"></td>
		...
		<tr></tr>
		<tr>
		<td colspan="4" style="text-align:center"><input type="submit" class="utt10" id="btn" value="Submit" name="submit">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		    		</td>
