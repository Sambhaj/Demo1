            ...
            <tr>
                <td style="height:50px">
                    <table style="width: 100%;" border="0" cellspacing="5px" cellpadding="5px">
                        <tr>
                           <td>
                               <span style="color:#DF1018;"><?php echo $req;?></span> NAME 

                           </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="text" name="name" placeholder="Enter Your Name" style="width:100%; height: 35px;padding-left:5px" value="<?php echo isset($_POST['name']) ? $_POST['name'] : ''; ?>">

                            </td>
                        </tr>
                        <tr>
                            <td>
                                <span style="color:#DF1018;"><?php echo $req;?></span> EMAIL 

                            </td>
                           </tr>
                          <tr>
                            <td>
                                <input type="text" name="email" onblur="emailvalidate();" id="email"  placeholder="Enter Your Email Id" style="width:100%; height: 35px;padding-left:5px" value="<?php echo isset($_POST['email']) ? $_POST['email'] : ''; ?>"><br><span style="display:none;color:#DF1018;font-weightbold;" id="emailMsg">Please enter valid email</span>

                            </td>
                        </tr>
                        <tr>
                            <td>
                                  <span style="color:#DF1018;"><?php echo $req;?></span> PHONE 

                            </td>
                             </tr>
                        <tr>
                            <td>
                                <input type="text"  onblur="mobval();" maxlength="10" id="mobno" placeholder="Enter Your Phone Number" style="width:100%; height: 35px;padding-left:5px" name="phone" value="<?php echo isset($_POST['phone']) ? $_POST['phone'] : ''; ?>"><br><span style="display:none;color:#DF1018;font-weightbold;" id="mobNumbMsg">Please enter correct mobile number</span>
                ...
                <td style="height:50px">
                     <table style="width: 100%;" border="0" cellspacing="5px" cellpadding="5px">
                        <tr>
                           <td>
                               <span style="color:#DF1018;"><?php echo $req;?></span> MESSAGE 

                           </td>
                            </tr>
                         <tr>
                            <td>
                                <textarea class="txtarea" name="message" rows="10" placeholder="Enter Your Message"  style="width:100%;height:155px;padding-left:5px"><?php echo isset($_POST['message']) ? $_POST['message'] : ''; ?></textarea>
                             </td>
                         </tr>
                         <tr>
                             <td>
